...
const CustomInput: React.ForwardRefRenderFunction<CustomInputRefs, CustomInputProps> = ({ type = 'default', label, textValue, style = styles, hasError = false, errorMsg = '', icon, descMsg, isEditing = true, autoFocus = false, ...otherProps }, ref) => {
