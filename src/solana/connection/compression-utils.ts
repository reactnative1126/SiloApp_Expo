...
// from: https://github.com/helius-labs/compression-examples/blob/main/utils.ts

// Creates a new merkle tree for compression.
export const initTree = async (
    connectionWrapper: HeliusConnectionWrapper,
...
// these use an old Token lib so commenting out (silo)
/*
...
export const createTransferAssetTx = async (
    connectionWrapper: HeliusConnectionWrapper,
    owner: PublicKey,
    newOwner: PublicKey,
    assetId: string
